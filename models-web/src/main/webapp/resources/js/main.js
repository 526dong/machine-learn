...
function lineBarMixedChart(id){
    ...
    var option = {
        ...
        xAxis:{
            ...
            data:['[0-1k]','[1-2k]','[2-3k]','[3-4k]','[4-5k]','[5-6k]']
        },
        yAxis:[{
            axisLine:{lineStyle:{color: '#103763'}},
            axisTick:{lineStyle:{color: '#7c808c'}},
        ...
        series:[
            {
                ...
                name: '样本数',
                barWidth: '30%',
                data:[4500,2500,2500,2500,2500,2500]
            },
            {
                type: 'line',
                name: '实际正样本率',
                yAxisIndex:1,
                symbol:'none',
                data:[1500,1500,1500,2500,2500,2500]
            },
            {
                type: 'line',
                name: '预计正样本率',
                symbol:'none',
                data:[3500,500,2500,1500,2500,2500]
            }
        ]
    };
    myChart.setOption(option);
...
// 半大概念分箱图
function mlineBarMixedChart(id){
    var myChart = echarts.init(document.getElementById(id));
    var option = {
        title: {show:false},
        color:['#028de2','#fcdc6f','red'],
