...
public interface ModelsReportMapper {
     ...
     */
    List<LinkedHashMap<String,Object>> getModelIVListById(@Param("programId")Long programId, @Param("arithmeticId")Long arithmeticId);
     ...
     */
    Map<String,Object> getDownloadUrlById(@Param("programId")Long programId, @Param("arithmeticId")Long arithmeticId);
