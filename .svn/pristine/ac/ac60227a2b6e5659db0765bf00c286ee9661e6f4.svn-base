...
$(function(){
	...
	$.validator.addMethod("isOnlyLoginName", function(value,element) {
		...
		var oldLoginName = "${user.loginName }";
		var flag = false;
	...
	if($("#userUpdate").valid()){
		...
		$.ajax({
			...
			success : function(data) {
				if (data.result != 1) {
					fnDelete("#popupp","用户编辑失败！");
				} else {
					fnDelete("#popupp","用户编辑成功！");
				}
			}
		});
	}
    ...
    <div class="main_center">
        ...
        <div class="right_content">
            <h3 class="place_title">
                ...
                <strong>/</strong>
                <a href="${ctx}/user/update?id=${userId }" class="active">编辑用户</a>
            </h3>
            <div class="module_box">
                        ...
                        <table class="main_table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="name" name="name" value="${user.name }" placeholder="请输入姓名" type="text" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="phone" name="phone" value="${user.phone }" placeholder="请输入手机号码" type="text" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="email" name="email" value="${user.email }" placeholder="请输入邮箱" type="text" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')">
                ...
                <div class="addBody_btn clear">
                	<a href="javaScript:saveUpdateUser();" class="addBody_btn_a1">保存</a>
