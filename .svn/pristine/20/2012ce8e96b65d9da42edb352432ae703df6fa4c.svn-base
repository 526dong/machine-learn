...
public class CommonFileValue {
    ...
    public static class DataFile {
        ...
        private List<ModelsFileValue> indexColumnValueList;
        ...
        public List<ModelsFileValue> getIndexColumnValueList() {
            return indexColumnValueList;
        }

        public void setIndexColumnValueList(List<ModelsFileValue> indexColumnValueList) {
            this.indexColumnValueList = indexColumnValueList;
        }
    }
