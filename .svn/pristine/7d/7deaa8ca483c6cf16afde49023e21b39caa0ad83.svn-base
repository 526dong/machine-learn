...
public class ModelsReportController extends BaseController {
	...
	public String toModelsReportPage(HttpServletRequest request){
		...
		request.setAttribute("dataFileId",programBasicInfoMap.get("dataFileId"));
	 ...
	 * @return
	 */
	@RequestMapping(value = "/getModelIVListData", method = RequestMethod.POST,produces="text/html;charset=UTF-8;")
	@ResponseBody
