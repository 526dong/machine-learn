...
$.Autocompleter.defaults = {
	...
	resultsClass: "input_box",//下拉框class
...
$.Autocompleter.Cache = function(options) {
	...
	function populate(){
		...
		for ( var i = 0, ol = options.data.length; i < ol; i++ ) {
			...
			if ( value === false || "undefined" == typeof(value) )
				continue;
	...
	return {
		...
		show: function() {
			...
			element.css({
				...
				//宽度
				width: typeof options.width == "string" || options.width > 0 ? "135" : $(input).width(),
