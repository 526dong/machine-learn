...
public class ModelsTrainLine1 {
    ...
    public ModelsTrainLine1() {
    }

    public ModelsTrainLine1(Long programId, Long arithmeticId, BigDecimal abscissa, BigDecimal tpr, BigDecimal ks, BigDecimal fpr, String creater, Date createTime) {
