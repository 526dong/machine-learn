...
public class ModelsTrainLine4 {
    ...
    public ModelsTrainLine4() {
    }

    public ModelsTrainLine4(Long programId, Long arithmeticId, BigDecimal abscissa, BigDecimal auc, String creater, Date createTime) {
